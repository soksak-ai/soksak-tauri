...
| 권한 | 사용처 |
|------|--------|
| `ui` | 사이드바 뷰(`soksak-bookmarks.list`) 등록 |
...
```sh
# git 레포로 배포하는 경우
sok plugin.install '{"url":"https://github.com/<you>/soksak-bookmarks"}'

# 이 레포의 예제를 직접 쓰는 경우: ~/.soksak/plugins/ 에 복사
cp -r examples/plugins/soksak-bookmarks ~/.soksak/plugins/soksak-bookmarks
```
