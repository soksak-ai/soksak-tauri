# 코드 하이라이트+ (`soksak-code-highlight`)
...
```
sok plugin.install source=<user>/<repo-soksak-code-highlight>
# 또는 로컬 경로로
sok plugin.install source=/path/to/examples/plugins/soksak-code-highlight
```
