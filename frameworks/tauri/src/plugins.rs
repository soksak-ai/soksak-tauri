...
// 스캐폴드의 몸은 크레이트가 진다 — 이 모듈의 이름으로 부르던 호출자가 그대로 서게 다시 내보낸다.
pub use soksak_scaffold::{
    plugin_dev_new2_in, plugin_dev_new_in, sidecar_dev_new_in, PluginInstallResult,
};
use soksak_scaffold::{git_run, set_tree_writable};
