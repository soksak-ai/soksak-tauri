...
const ko = {
  ...
  "project.aliasPh": "폴더명",
  "project.id": "프로젝트 id",
  "project.idPh": "my-project",
  "project.idHint": "자동 지정 — ~/soksak/{id} 폴더를 만들어 사용합니다",
  "project.idInvalid": "id 는 영문 소문자·숫자·하이픈만 (예: my-project)",
  "project.idAsAlias": "id 는 탭 표시명으로도 쓰입니다(생성 후 설정에서 변경 가능)",
...
const en: Record<MsgKey, string> = {
  ...
  "project.idPh": "my-project",
  "project.idHint": "Auto — creates and uses ~/soksak/{id}",
  "project.idInvalid": "id allows lowercase letters, digits, hyphens (e.g. my-project)",
  "project.idAsAlias": "id is also the tab name (changeable later in settings)",
