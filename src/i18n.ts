...
const ko = {
  ...
  "settings.browserNewWindow": "새 링크 열기",
  "browserNewWindow.window": "새 OS 창",
  "browserNewWindow.tab": "앱 내 탭",
  "common.on": "켬",
  "common.off": "끔",
...
const en: Record<MsgKey, string> = {
  ...
  "settings.browserNewWindow": "New link opens as",
  "browserNewWindow.window": "New OS window",
  "browserNewWindow.tab": "In-app tab",
  "common.on": "On",
  "common.off": "Off",
  ...
  "browser.inspect": "Inspect (devtools)",
