                      ...
                      void deps
                        .invoke("activity_publish", {
                          ...
                          payload: {
                            ...
                            available: false,
                            // 보이는 줄은 **무엇이 안 되고 왜인지**를 말한다. 기전("이 앱은
                            // 감시하지 않습니다")만 적으면 읽는 쪽은 누가 무엇을 못 하게 됐는지
                            // 모른다 — 누가 요청했고 그래서 무엇이 안 도는지를 적는다.
                            // 프레임워크가 거절한 개발자용 사유는 페이로드에 둔다.
                            plugin: id,
                            message: `· ${id} 의 클립보드 변경 감지가 동작하지 않습니다 — 이 앱은 클립보드 변경 사건을 주지 않습니다`,
