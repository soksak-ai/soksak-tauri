...
### Narration — two axes only: message (eye) / speak (ear)
...
- The former `CommandSpec.tts` boolean and the envelope `tts` override are retired — speak alone replaces them (no fragmentation).
