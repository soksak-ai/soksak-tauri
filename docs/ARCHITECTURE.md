...
(xterm.js) and `soksak-plugin-terminal-ghostty` both implement `soksak-spec-plugin-terminal@0.0.1`; the core
...
(`soksak-spec-sidecar-browser@0.0.1`) the skeleton relays without understanding.
