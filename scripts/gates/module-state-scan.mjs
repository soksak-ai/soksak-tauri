...
//
// 실측 2026-07-31: 106. 코어 명령·뷰 등록부와 플러그인 활성·버스·훅·헤더·상태바처럼 **다른
// 모듈이 채우는** 자리는 이미 내렸다. 남은 것은 대부분 자기 모듈이 채우는 캐시·카운터라
// 사라져도 재생성되지만, 그 판별을 사람이 매번 하면 하나를 놓친다 — 0 까지 내린다.
const DECLARED_CAP = 106;
