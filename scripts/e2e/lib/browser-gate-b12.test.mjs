...
// 표본은 정본 한 자리에서 온다 — 이 파일이 자기 표본을 들면 기여·병합 쪽 표본과 조용히 갈린다.
import {
  B12_PRESENTED_COMPOSITION as PRESENTED_COMPOSITION,
  B12_ROLES as ROLES,
  b12AllSamples as allSamples,
  b12Evidence as evidence,
  b12Identity as identity,
} from "./browser-gate-b12-fixture.mjs";
